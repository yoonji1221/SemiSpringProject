  ...
  <nav class="nav" role="navigation">
    <ul class="nav__list">
      <li>
        ...
        <label for="group-1"><span class="fa fa-angle-right"></span>나의 가구정보</label>
        <%--
        <ul class="group-list">
      ...
      <li>
        ...
        <label for="group-2"><span class="fa fa-angle-right"></span> <a href="/wherepay/mypage?mas_num=${mas_num}" id="first_1"> 나의 가구관리</a></label>
        <%-- 
        <ul class="group-list">
          <li>
      ...
      <li>
        ...
        <label for="group-3"><span class="fa fa-angle-right"></span><a href="/wherepay/household?mas_num=${mas_num}" id="first_1">가계부</a></label>
         <%-- 
        <ul class="group-list">
          <li>

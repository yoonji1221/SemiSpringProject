      ...
      var sam_gu = $("#address option:selected").val();
       ...
       $.ajax({
             ...
             success : function(resultlist) {
                //$("#outter").remove();
                var table = $("<table id=\"table2\" class=\"table table-bordered table-striped\"><thead><tr><th>번호</th><th>가맹점명</th><th>주소</th><th nowrap>업종분류</th><th nowrap>상세분류</th><th nowrap>전화번호</th></tr></thead>");
   ...
   if(value == 2 || value==3){ //선불카드, 상품권 선택 제로페이 데이터 조회
      ...
      var sam_gu = $("#address option:selected").val();
       ...
       $.ajax({
             ...
             success : function(resultlist) {
                //$("#outter").remove();
                var table = $("<table id=\"table2\" class=\"table table-bordered table-striped\"><thead><tr><th>번호</th><th>가맹점명</th><th>주소</th><th nowrap>업종분류</th><th nowrap>상세분류</th><th nowrap>관리자 이름</th></tr></thead>");
                $("#tab2").append(table);
                 for(var idx in resultlist){
   ...
   <main id="main" style="margin-top: 0px;">
      ...
      <div class="container">
       <div class="section-title">
         ...
         </select> <input id="button1" type=button value="검색" class="btn"
